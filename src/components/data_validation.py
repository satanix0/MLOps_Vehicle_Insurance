...
class DataValidation:
    def __init__(self, data_ingestion_artifact: DataIngestionArtifact, data_validation_config: DataValidationConfig):
        ...
        """
        try:
            # data_ingestion_artifact instance is needed to fetch the tain/test data for validation
    ...
    def validate_number_of_columns(self, dataframe: DataFrame) -> bool:
        ...
        """
        try:
            # False if the number of columns in the dataframe is not equal to the number of columns defined in the schema
    ...
    def is_column_exist(self, df: DataFrame) -> bool:
        ...
        Description :   This method validates the existence of numerical and categorical columns i.e. checks for missing columns
    ...
    def initiate_data_validation(self) -> DataValidationArtifact:
        ...
        try:
            ...
            # Checking col len of dataframe for test df
            ...
            # if no error, validation_error_msg should be empty.
