...
from src.utils.main_utils import load_numpy_array_data, load_object, save_object, save_metrics
...
class ModelTrainer:
    ...
    def get_trained_model_object_and_eval_rep(self, train: np.array, test: np.array) -> Tuple[object, object]:
        """
        Method Name :   get_trained_model_object_and_eval_rep
        Description :   This function takes train and test data as inputs, 
                        and trains a RandomForestClassifier with specified parameters
        ...
        try:
            ...
            # Initialize RandomForestClassifier with parameters specified in constants
    ...
    def initiate_model_trainer(self) -> ModelTrainerArtifact:
        ...
        try:
            ...
            trained_model, metric_artifact = self.get_trained_model_object_and_eval_rep(
            ...
            my_model_predictions = MyModel(
                preprocessing_object=preprocessing_obj, trained_model_object=trained_model)
            save_object(
                self.model_trainer_config.trained_model_file_path, my_model_predictions)
            logging.info(
